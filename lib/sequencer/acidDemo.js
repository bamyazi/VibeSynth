...
export function createAcidDemo() {
  ...
  // Bass continues
  melodicSeq.voicePattern[0][7][0] = { active: true, length: 2, accent: false, slide: false };
  melodicSeq.voicePattern[0][6][2] = { active: true, length: 2, accent: false, slide: false };
  melodicSeq.voicePattern[0][7][4] = { active: true, length: 2, accent: false, slide: false };
  melodicSeq.voicePattern[0][5][6] = { active: true, length: 2, accent: false, slide: false };
  melodicSeq.voicePattern[0][7][8] = { active: true, length: 2, accent: false, slide: false };
  melodicSeq.voicePattern[0][6][10] = { active: true, length: 2, accent: false, slide: false };
  melodicSeq.voicePattern[0][7][12] = { active: true, length: 2, accent: false, slide: false };
  melodicSeq.voicePattern[0][4][14] = { active: true, length: 2, accent: false, slide: false };
  // Hypnotic arpeggio
  melodicSeq.voicePattern[1][2][0] = { active: true, length: 1, accent: false, slide: false };   // G4
  melodicSeq.voicePattern[1][5][2] = { active: true, length: 1, accent: false, slide: false };   // C4
  melodicSeq.voicePattern[1][4][4] = { active: true, length: 1, accent: false, slide: false };   // D4
  melodicSeq.voicePattern[1][2][6] = { active: true, length: 1, accent: false, slide: false };   // G4
  melodicSeq.voicePattern[1][5][8] = { active: true, length: 1, accent: false, slide: false };   // C4
  melodicSeq.voicePattern[1][3][10] = { active: true, length: 1, accent: false, slide: false };  // E4
  melodicSeq.voicePattern[1][2][12] = { active: true, length: 1, accent: false, slide: false };  // G4
  melodicSeq.voicePattern[1][5][14] = { active: true, length: 1, accent: false, slide: false };  // C4
  // Drums
  [0,4,8,12].forEach(s => melodicSeq.drumPattern[0][s] = true);
  melodicSeq.drumPattern[3][2] = melodicSeq.drumPattern[3][6] = melodicSeq.drumPattern[3][10] = melodicSeq.drumPattern[3][14] = true;
  melodicSeq.drumPattern[5][4] = melodicSeq.drumPattern[5][12] = true;
  ...
  return {
    ...
    waveTypes: ['triangle', 'pulse', 'noise'],
    octaves: [-2, 0, 1],
    
    voiceSettings: [
      // Voice 1: Deep sub bass
      {
        adsr: { attack: 0.01, decay: 0.15, sustain: 0.7, release: 0.1 },
        pwm: { pulseWidth: 0.5 },
    ...
    mixerSettings: [
      // Voice 1: Deep bass - warm low-pass
      {
        volume: 1.0,
        lpEnabled: true,
        lpFreq: 600,
