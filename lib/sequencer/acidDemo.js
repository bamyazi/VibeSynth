...
export function createAcidDemo() {
  ...
  // Aggressive Reese bass with slides
  rollingBass.voicePattern[0][7][0] = { active: true, length: 1, accent: true, slide: false };    // G3
  rollingBass.voicePattern[0][6][2] = { active: true, length: 1, accent: false, slide: true };    // A3 slide
  rollingBass.voicePattern[0][5][4] = { active: true, length: 1, accent: true, slide: false };    // C4
  rollingBass.voicePattern[0][7][5] = { active: true, length: 1, accent: false, slide: true };    // G3 slide
  rollingBass.voicePattern[0][7][8] = { active: true, length: 1, accent: true, slide: false };    // G3
  rollingBass.voicePattern[0][4][10] = { active: true, length: 1, accent: false, slide: false };  // D4
  rollingBass.voicePattern[0][6][12] = { active: true, length: 1, accent: false, slide: true };   // A3 slide
  rollingBass.voicePattern[0][7][14] = { active: true, length: 2, accent: false, slide: false };  // G3
