...
export function createAcidDemo() {
  ...
  // Nasty long Reese bass with gritty slides
  rollingBass.voicePattern[0][7][0] = { active: true, length: 8, accent: true, slide: false };    // G3 long
  rollingBass.voicePattern[0][6][4] = { active: true, length: 4, accent: false, slide: true };    // A3 slide
  rollingBass.voicePattern[0][7][8] = { active: true, length: 8, accent: true, slide: false };    // G3 long
  rollingBass.voicePattern[0][5][12] = { active: true, length: 4, accent: false, slide: true };   // C4 slide
  ...
  // Syncopated bass with slides
  bassPerc.voicePattern[0][7][0] = { active: true, length: 1, accent: true, slide: false };   // G3
  bassPerc.voicePattern[0][6][3] = { active: true, length: 1, accent: false, slide: true };   // A3 slide
  bassPerc.voicePattern[0][5][4] = { active: true, length: 1, accent: false, slide: false };  // C4
  bassPerc.voicePattern[0][7][6] = { active: true, length: 1, accent: false, slide: true };   // G3 slide
  bassPerc.voicePattern[0][7][8] = { active: true, length: 1, accent: true, slide: false };   // G3
  bassPerc.voicePattern[0][4][10] = { active: true, length: 1, accent: false, slide: false }; // D4
  bassPerc.voicePattern[0][5][11] = { active: true, length: 1, accent: false, slide: true };  // C4 slide
  bassPerc.voicePattern[0][6][14] = { active: true, length: 2, accent: false, slide: false }; // A3
  // Techno percussion
  ...
  // Bass - crazy acid line with tons of slides and accents
  melodicSeq.voicePattern[0][7][0] = { active: true, length: 1, accent: true, slide: false };    // G3
  melodicSeq.voicePattern[0][5][1] = { active: true, length: 1, accent: false, slide: true };    // C4 slide
  melodicSeq.voicePattern[0][4][2] = { active: true, length: 1, accent: true, slide: true };     // D4 slide
  melodicSeq.voicePattern[0][7][3] = { active: true, length: 1, accent: false, slide: false };   // G3
  melodicSeq.voicePattern[0][6][4] = { active: true, length: 1, accent: true, slide: false };    // A3
  melodicSeq.voicePattern[0][7][5] = { active: true, length: 1, accent: false, slide: true };    // G3 slide
  melodicSeq.voicePattern[0][5][6] = { active: true, length: 1, accent: true, slide: true };     // C4 slide
  melodicSeq.voicePattern[0][6][7] = { active: true, length: 1, accent: false, slide: false };   // A3
  melodicSeq.voicePattern[0][7][8] = { active: true, length: 1, accent: true, slide: false };    // G3
  melodicSeq.voicePattern[0][4][9] = { active: true, length: 1, accent: false, slide: true };    // D4 slide
  melodicSeq.voicePattern[0][6][10] = { active: true, length: 1, accent: true, slide: false };   // A3
  melodicSeq.voicePattern[0][7][11] = { active: true, length: 1, accent: false, slide: true };   // G3 slide
  melodicSeq.voicePattern[0][5][12] = { active: true, length: 1, accent: true, slide: false };   // C4
  melodicSeq.voicePattern[0][6][13] = { active: true, length: 1, accent: false, slide: true };   // A3 slide
  melodicSeq.voicePattern[0][4][14] = { active: true, length: 1, accent: true, slide: true };    // D4 slide
  melodicSeq.voicePattern[0][7][15] = { active: true, length: 1, accent: false, slide: false };  // G3
  // Melodic sequence - wild acid stabs
  melodicSeq.voicePattern[1][3][1] = { active: true, length: 1, accent: true, slide: false };    // E4
  melodicSeq.voicePattern[1][2][3] = { active: true, length: 1, accent: true, slide: true };     // G4 slide
  melodicSeq.voicePattern[1][1][5] = { active: true, length: 1, accent: false, slide: false };   // A4
  melodicSeq.voicePattern[1][3][7] = { active: true, length: 1, accent: true, slide: false };    // E4
  melodicSeq.voicePattern[1][2][9] = { active: true, length: 1, accent: true, slide: true };     // G4 slide
  melodicSeq.voicePattern[1][4][11] = { active: true, length: 1, accent: false, slide: false };  // D4
  melodicSeq.voicePattern[1][3][13] = { active: true, length: 1, accent: true, slide: false };   // E4
  melodicSeq.voicePattern[1][2][15] = { active: true, length: 1, accent: false, slide: true };   // G4 slide
  // Drums - more driving
  ...
  // Pulsing low bass instead of drone
  droneStabs.voicePattern[0][7][0] = { active: true, length: 4, accent: true, slide: false };   // G3
  droneStabs.voicePattern[0][7][4] = { active: true, length: 3, accent: false, slide: false };  // G3
  droneStabs.voicePattern[0][6][8] = { active: true, length: 4, accent: true, slide: false };   // A3
  droneStabs.voicePattern[0][6][12] = { active: true, length: 3, accent: false, slide: false }; // A3
  // Mid rhythmic stabs
  ...
  return {
    ...
    voiceSettings: [
      // Voice 1: Nasty Reese bass - heavily detuned saws with massive distortion
      {
        adsr: { attack: 0.005, decay: 0.08, sustain: 0.95, release: 0.05 },
        pwm: { pulseWidth: 0.5 },
      ...
      // Voice 2: Classic 303 acid lead - aggressive filter sweep and resonance
      {
        adsr: { attack: 0.003, decay: 0.08, sustain: 0.5, release: 0.15 },
        pwm: { pulseWidth: 0.5 },
    ...
    mixerSettings: [
      ...
      // Voice 1: Nasty Reese bass with sweeping filter
      {
        volume: 0.95,
        lpEnabled: true,
        lpFreq: 450,
      ...
      // Voice 2: Melodic lead - warm and spacious
      {
        volume: 0.8,
        lpEnabled: true,
        lpFreq: 5000,
