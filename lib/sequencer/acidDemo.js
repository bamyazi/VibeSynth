...
export function createAcidDemo() {
  ...
  rollingBass.voicePattern[0][7][0] = { active: true, length: 4, accent: true, slide: false };    // G3 long
  rollingBass.voicePattern[0][6][4] = { active: true, length: 3, accent: false, slide: true };    // A3 slide
  rollingBass.voicePattern[0][7][8] = { active: true, length: 4, accent: true, slide: false };    // G3 long
  rollingBass.voicePattern[0][5][12] = { active: true, length: 3, accent: false, slide: true };   // C4 slide
